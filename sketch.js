...
function setup() {//setup st
  ...
  imgObj[35] = new imgLoaded(3,53,88,68,97);
  imgObj[36] = new imgLoaded(3,121,72,142,74);
  imgObj[37] = new imgLoaded(3,266,51,56,64);
  imgObj[38] = new imgLoaded(3,323,49,58,64);
  imgObj[39] = new imgLoaded(3,383,49,48,64);
  imgObj[40] = new imgLoaded(3,435,50,73,76);
  imgObj[41] = new imgLoaded(3,508,39,55,44);
  imgObj[42] = new imgLoaded(3,564,40,48,43);
  imgObj[43] = new imgLoaded(3,509,85,55,37);
  imgObj[44] = new imgLoaded(3,566,85,61,38);
  imgObj[45] = new imgLoaded(3,629,85,63,49);
  imgObj[46] = new imgLoaded(3,694,83,55,45);
  imgObj[47] = new imgLoaded(3,749,86,47,58);
  imgObj[48] = new imgLoaded(3,797,85,54,58);
  imgObj[49] = new imgLoaded(3,0,135,51,50);
  imgObj[50] = new imgLoaded(3,123,147,74,65);
  imgObj[51] = new imgLoaded(3,198,148,63,66);
  imgObj[52] = new imgLoaded(3,266,115,57,76);
  imgObj[53] = new imgLoaded(3,325,116,59,74);
  imgObj[54] = new imgLoaded(3,386,115,45,75);
  imgObj[55] = new imgLoaded(3,432,127,120,79);
  imgObj[56] = new imgLoaded(3,555,124,63,82);
  imgObj[57] = new imgLoaded(3,628,135,63,56);
  imgObj[58] = new imgLoaded(3,693,135,56,56);
  imgObj[59] = new imgLoaded(3,751,145,52,71);
  imgObj[60] = new imgLoaded(3,804,145,47,70);
  imgObj[61] = new imgLoaded(3,0,186,51,45);
  imgObj[62] = new imgLoaded(3,53,186,70,85);
  imgObj[63] = new imgLoaded(3,125,215,72,56);
  imgObj[64] = new imgLoaded(3,198,214,65,58);
  imgObj[65] = new imgLoaded(3,263,193,61,58);
  imgObj[66] = new imgLoaded(3,325,194,87,56);
  imgObj[67] = new imgLoaded(3,363,194,60,56);
  imgObj[68] = new imgLoaded(3,435,209,72,60);
  imgObj[69] = new imgLoaded(3,509,209,61,60);
  imgObj[70] = new imgLoaded(3,571,209,58,59);
  imgObj[71] = new imgLoaded(3,629,192,61,47);
  imgObj[72] = new imgLoaded(3,693,192,57,47);
  imgObj[73] = new imgLoaded(3,751,220,53,54);
  imgObj[74] = new imgLoaded(3,806,220,45,55);
  imgObj[75] = new imgLoaded(3,0,235,51,58);
  imgObj[76] = new imgLoaded(3,52,273,71,54);
  imgObj[77] = new imgLoaded(3,124,273,70,54);
  imgObj[78] = new imgLoaded(3,263,254,83,58);
  imgObj[79] = new imgLoaded(3,344,254,82,69);
  imgObj[80] = new imgLoaded(3,434,271,55,51);
  imgObj[81] = new imgLoaded(3,492,271,78,53);
  imgObj[82] = new imgLoaded(3,571,270,56,56);
  imgObj[83] = new imgLoaded(3,630,241,59,46);
  imgObj[84] = new imgLoaded(3,691,241,60,45);
  imgObj[85] = new imgLoaded(3,628,289,52,36);
  imgObj[86] = new imgLoaded(3,680,288,72,37);
  imgObj[87] = new imgLoaded(3,253,276,53,48);
  imgObj[88] = new imgLoaded(3,807,226,44,48);
  imgObj[89] = new imgLoaded(3,0,295,50,69);
  imgObj[90] = new imgLoaded(3,52,331,56,81);
  imgObj[91] = new imgLoaded(3,109,331,86,47);
  imgObj[92] = new imgLoaded(3,197,330,64,91);
  imgObj[93] = new imgLoaded(3,266,316,80,59);
  imgObj[94] = new imgLoaded(3,263,375,38,59);
  imgObj[95] = new imgLoaded(3,302,277,44,57);
  imgObj[96] = new imgLoaded(3,349,325,46,62);
  imgObj[97] = new imgLoaded(3,309,325,62,47);
  imgObj[98] = new imgLoaded(3,348,390,47,44);
  imgObj[99] = new imgLoaded(3,397,323,64,61);
  imgObj[100] = new imgLoaded(3,462,325,49,49);
  imgObj[101] = new imgLoaded(3,514,326,60,52);
  imgObj[102] = new imgLoaded(3,463,377,51,57);
  imgObj[103] = new imgLoaded(3,514,375,60,47);
  imgObj[104] = new imgLoaded(3,576,327,82,64);
  imgObj[105] = new imgLoaded(3,660,325,60,66);
  imgObj[106] = new imgLoaded(3,724,327,44,39);
  imgObj[107] = new imgLoaded(3,771,326,39,32);
  imgObj[108] = new imgLoaded(3,810,325,41,40);
  imgObj[109] = new imgLoaded(3,724,367,47,26);
  imgObj[110] = new imgLoaded(3,771,359,39,33);
  imgObj[111] = new imgLoaded(3,812,365,39,28);
  imgObj[112] = new imgLoaded(3,0,368,50,45);
  imgObj[113] = new imgLoaded(3,0,414,110,65);
  imgObj[114] = new imgLoaded(3,110,378,87,100);
  imgObj[115] = new imgLoaded(3,199,422,61,55);
  imgObj[116] = new imgLoaded(3,263,437,48,41);
  imgObj[117] = new imgLoaded(3,312,437,48,41);
  imgObj[118] = new imgLoaded(3,362,437,99,41);
  imgObj[119] = new imgLoaded(3,462,435,55,43);
  imgObj[120] = new imgLoaded(3,516,423,57,55);
  imgObj[121] = new imgLoaded(3,575,392,62,87);
  imgObj[122] = new imgLoaded(3,639,394,38,39);
  imgObj[123] = new imgLoaded(3,678,393,49,42);
  imgObj[124] = new imgLoaded(3,728,395,38,38);
  imgObj[125] = new imgLoaded(3,767,395,48,37);
  imgObj[126] = new imgLoaded(3,818,395,33,14);
  imgObj[126] = new imgLoaded(639,436,40,41);
  imgObj[126] = new imgLoaded(680,436,46,41);
  imgObj[126] = new imgLoaded(728,435,88,43);
  imgObj[126] = new imgLoaded(817,442,34,37);
